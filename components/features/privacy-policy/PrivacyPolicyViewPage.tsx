      ...
      >
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-emerald-500/20 rounded-2xl p-8 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    applications, including features used, time spent, and
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    operating system, and IP address for security and
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                outlined in this policy. You may request deletion of your
        ...
        <motion.div variants={item} className="mt-12 text-center">
          <p className="text-gray-400">
            ...
            your personal information while providing the best possible
            experience with ShanHub.
          </p>
        </motion.div>
      </motion.div>
    </div>
